package com.knowgate.arrayutils;
...
public class Arr {
    ...
    /**
     * <p>Array instances should NOT be constructed in standard programming.
     * Instead, the class should be used as <code>Arr.clone(new int[] {2})</code>.
     *
     ...
     * Map colorMap = Arr.toMap(new String[][] {
     *     {"RED", "#FF0000"},
     *     {"GREEN", "#00FF00"},
     *     {"BLUE", "#0000FF"}});
     * </pre>
     ...
     *
     * <pre>
    String[] array = Arr.toArray("1", "2");
    String[] emptyArray = Arr.&lt;String&gt;toArray();
     * </pre>
     *
     ...
     * <code>Number[] array = Arr.&lt;Number&gt;toArray(Integer.valueOf(42), Double.valueOf(Math.PI))</code>,
     ...
     *
     * <pre>
     * Date[] someDates = (Date[])Arr.subarray(allDates, 2, 5);
     * </pre>
     *
     * @param <T> the component type of the array
     ...
     *
     * <pre>
     * Arr.getLength(null)            = 0
     * Arr.getLength([])              = 0
     * Arr.getLength([null])          = 1
     * Arr.getLength([true, false])   = 2
     * Arr.getLength([1, 2, 3])       = 3
     * Arr.getLength(["a", "b", "c"]) = 3
     * </pre>
     *
     ...
     * Examples:
     * <ul>
     *     <li>Arr.swap(["1", "2", "3"], 0, 2) -&gt; ["3", "2", "1"]</li>
     *     <li>Arr.swap(["1", "2", "3"], 0, 0) -&gt; ["1", "2", "3"]</li>
     *     <li>Arr.swap(["1", "2", "3"], 1, 0) -&gt; ["2", "1", "3"]</li>
     *     <li>Arr.swap(["1", "2", "3"], 0, 5) -&gt; ["1", "2", "3"]</li>
     *     <li>Arr.swap(["1", "2", "3"], -1, 1) -&gt; ["2", "1", "3"]</li>
     * </ul>
     *
     ...
     * Examples:
     * <ul>
     *     <li>Arr.swap([true, false, true], 0, 2) -&gt; [true, false, true]</li>
     *     <li>Arr.swap([true, false, true], 0, 0) -&gt; [true, false, true]</li>
     *     <li>Arr.swap([true, false, true], 1, 0) -&gt; [false, true, true]</li>
     *     <li>Arr.swap([true, false, true], 0, 5) -&gt; [true, false, true]</li>
     *     <li>Arr.swap([true, false, true], -1, 1) -&gt; [false, true, true]</li>
     * </ul>
     *
     *
     * @param array  the array to swap, may be {@code null}
     ...
     * Examples:
     * <ul>
     *     <li>Arr.swap([true, false, true, false], 0, 2, 1) -&gt; [true, false, true, false]</li>
     *     <li>Arr.swap([true, false, true, false], 0, 0, 1) -&gt; [true, false, true, false]</li>
     *     <li>Arr.swap([true, false, true, false], 0, 2, 2) -&gt; [true, false, true, false]</li>
     *     <li>Arr.swap([true, false, true, false], -3, 2, 2) -&gt; [true, false, true, false]</li>
     *     <li>Arr.swap([true, false, true, false], 0, 3, 3) -&gt; [false, false, true, true]</li>
     * </ul>
     *
     * @param array the array to swap, may be {@code null}
     ...
     * Examples:
     * <ul>
     *     <li>Arr.swap([1, 2, 3, 4], 0, 2, 1) -&gt; [3, 2, 1, 4]</li>
     *     <li>Arr.swap([1, 2, 3, 4], 0, 0, 1) -&gt; [1, 2, 3, 4]</li>
     *     <li>Arr.swap([1, 2, 3, 4], 2, 0, 2) -&gt; [3, 4, 1, 2]</li>
     *     <li>Arr.swap([1, 2, 3, 4], -3, 2, 2) -&gt; [3, 4, 1, 2]</li>
     *     <li>Arr.swap([1, 2, 3, 4], 0, 3, 3) -&gt; [4, 2, 3, 1]</li>
     * </ul>
     *
     * @param array the array to swap, may be {@code null}
     * @param offset1 the index of the first element in the series to swap
    ...
    */
     ...
     *
     * <pre>
     * Arr.addAll(null, null)     = null
     * Arr.addAll(array1, null)   = cloned copy of array1
     * Arr.addAll(null, array2)   = cloned copy of array2
     * Arr.addAll([], [])         = []
     * Arr.addAll([null], [null]) = [null, null]
     * Arr.addAll(["a", "b", "c"], ["1", "2", "3"]) = ["a", "b", "c", "1", "2", "3"]
     * </pre>
     *
     * @param <T> the component type of the array
     ...
     *
     * <pre>
     * Arr.add(null, null)      = [null]
     * Arr.add(null, "a")       = ["a"]
     * Arr.add(["a"], null)     = ["a", null]
     * Arr.add(["a"], "b")      = ["a", "b"]
     * Arr.add(["a", "b"], "c") = ["a", "b", "c"]
     * </pre>
     *
     ...
     *
     * <pre>
     * Arr.add(null, true)          = [true]
     * Arr.add([true], false)       = [true, false]
     * Arr.add([true, false], true) = [true, false, true]
     * </pre>
     *
     ...
     *
     * <pre>
     * Arr.add(null, 0, null)      = [null]
     * Arr.add(null, 0, "a")       = ["a"]
     * Arr.add(["a"], 1, null)     = ["a", null]
     * Arr.add(["a"], 1, "b")      = ["a", "b"]
     * Arr.add(["a", "b"], 3, "c") = ["a", "b", "c"]
     * </pre>
     *
     * @param <T> the component type of the array
     * @param array  the array to add the element to, may be {@code null}
     ...
     *
     * <pre>
     * Arr.add(null, 0, true)          = [true]
     * Arr.add([true], 0, false)       = [false, true]
     * Arr.add([false], 1, true)       = [false, true]
     * Arr.add([true, false], 1, true) = [true, true, false]
     * </pre>
     *
     * @param array  the array to add the element to, may be {@code null}
     * @param index  the position of the new object
     ...
     * Arr.add(null, 0, 'a')            = ['a']
     * Arr.add(['a'], 0, 'b')           = ['b', 'a']
     * Arr.add(['a', 'b'], 0, 'c')      = ['c', 'a', 'b']
     * Arr.add(['a', 'b'], 1, 'k')      = ['a', 'k', 'b']
     * Arr.add(['a', 'b', 'c'], 1, 't') = ['a', 't', 'b', 'c']
     * </pre>
     *
     * @param array  the array to add the element to, may be {@code null}
     * @param index  the position of the new object
     ...
     * <pre>
     * Arr.add([1], 0, 2)         = [2, 1]
     * Arr.add([2, 6], 2, 3)      = [2, 6, 3]
     * Arr.add([2, 6], 0, 1)      = [1, 2, 6]
     * Arr.add([2, 6, 3], 2, 1)   = [2, 6, 1, 3]
     * </pre>
     *
     * @param array  the array to add the element to, may be {@code null}
     * @param index  the position of the new object
     ...
     * <pre>
     * Arr.add([1], 0, 2)         = [2, 1]
     * Arr.add([2, 6], 2, 10)     = [2, 6, 10]
     * Arr.add([2, 6], 0, -4)     = [-4, 2, 6]
     * Arr.add([2, 6, 3], 2, 1)   = [2, 6, 1, 3]
     * </pre>
     *
     * @param array  the array to add the element to, may be {@code null}
     ...
     *
     * <pre>
     * Arr.add([1L], 0, 2L)           = [2L, 1L]
     * Arr.add([2L, 6L], 2, 10L)      = [2L, 6L, 10L]
     * Arr.add([2L, 6L], 0, -4L)      = [-4L, 2L, 6L]
     * Arr.add([2L, 6L, 3L], 2, 1L)   = [2L, 6L, 1L, 3L]
     * </pre>
     *
     * @param array  the array to add the element to, may be {@code null}
     * @param index  the position of the new object
     ...
     *
     * <pre>
     * Arr.add([1.1f], 0, 2.2f)               = [2.2f, 1.1f]
     * Arr.add([2.3f, 6.4f], 2, 10.5f)        = [2.3f, 6.4f, 10.5f]
     * Arr.add([2.6f, 6.7f], 0, -4.8f)        = [-4.8f, 2.6f, 6.7f]
     * Arr.add([2.9f, 6.0f, 0.3f], 2, 1.0f)   = [2.9f, 6.0f, 1.0f, 0.3f]
     * </pre>
     *
     * @param array  the array to add the element to, may be {@code null}
     * @param index  the position of the new object
     ...
     *
     * <pre>
     * Arr.add([1.1], 0, 2.2)              = [2.2, 1.1]
     * Arr.add([2.3, 6.4], 2, 10.5)        = [2.3, 6.4, 10.5]
     * Arr.add([2.6, 6.7], 0, -4.8)        = [-4.8, 2.6, 6.7]
     * Arr.add([2.9, 6.0, 0.3], 2, 1.0)    = [2.9, 6.0, 1.0, 0.3]
     * </pre>
     *
     * @param array  the array to add the element to, may be {@code null}
     * @param index  the position of the new object
     ...
     *
     * <pre>
     * Arr.removeElement(null, "a")            = null
     * Arr.removeElement([], "a")              = []
     * Arr.removeElement(["a"], "b")           = ["a"]
     * Arr.removeElement(["a", "b"], "a")      = ["b"]
     * Arr.removeElement(["a", "b", "a"], "a") = ["b", "a"]
     * </pre>
     *
     * @param <T> the component type of the array
     ...
     * <pre>
     * Arr.remove([true], 0)              = []
     * Arr.remove([true, false], 0)       = [false]
     * Arr.remove([true, false], 1)       = [true]
     * Arr.remove([true, true, false], 1) = [true, false]
     * </pre>
     *
     * @param array  the array to remove the element from, may not be {@code null}
     * @param index  the position of the element to be removed
     ...
     *
     * <pre>
     * Arr.removeElement(null, true)                = null
     * Arr.removeElement([], true)                  = []
     * Arr.removeElement([true], false)             = [true]
     * Arr.removeElement([true, false], false)      = [true]
     * Arr.removeElement([true, false, true], true) = [false, true]
     * </pre>
     *
     * @param array  the array to remove the element from, may be {@code null}
     * @param element  the element to be removed
     ...
     *
     * <pre>
     * Arr.removeElement(null, 1)        = null
     * Arr.removeElement([], 1)          = []
     * Arr.removeElement([1], 0)         = [1]
     * Arr.removeElement([1, 0], 0)      = [1]
     * Arr.removeElement([1, 0, 1], 1)   = [0, 1]
     * </pre>
     *
     * @param array  the array to remove the element from, may be {@code null}
     * @param element  the element to be removed
     ...
     * <pre>
     * Arr.remove([1.1], 0)           = []
     * Arr.remove([2.5, 6.0], 0)      = [6.0]
     * Arr.remove([2.5, 6.0], 1)      = [2.5]
     * Arr.remove([2.5, 6.0, 3.8], 1) = [2.5, 3.8]
     * </pre>
     *
     * @param array  the array to remove the element from, may not be {@code null}
     * @param index  the position of the element to be removed
     ...
     *
     * <pre>
     * Arr.removeElement(null, 1.1)            = null
     * Arr.removeElement([], 1.1)              = []
     * Arr.removeElement([1.1], 1.2)           = [1.1]
     * Arr.removeElement([1.1, 2.3], 1.1)      = [2.3]
     * Arr.removeElement([1.1, 2.3, 1.1], 1.1) = [2.3, 1.1]
     * </pre>
     *
     * @param array  the array to remove the element from, may be {@code null}
     * @param element  the element to be removed
     ...
     * Arr.removeElement(null, 1)      = null
     * Arr.removeElement([], 1)        = []
     * Arr.removeElement([1], 2)       = [1]
     * Arr.removeElement([1, 3], 1)    = [3]
     * Arr.removeElement([1, 3, 1], 1) = [3, 1]
     * </pre>
     *
     * @param array  the array to remove the element from, may be {@code null}
     * @param element  the element to be removed
     ...
     *
     * <pre>
     * Arr.removeAll(["a", "b", "c"], 0, 2) = ["b"]
     * Arr.removeAll(["a", "b", "c"], 1, 2) = ["a"]
     * </pre>
     *
     * @param <T> the component type of the array
     * @param array   the array to remove the element from, may not be {@code null}
     ...
     * <pre>
     * Arr.removeAll([1], 0)             = []
     * Arr.removeAll([2, 6], 0)          = [6]
     * Arr.removeAll([2, 6], 0, 1)       = []
     * Arr.removeAll([2, 6, 3], 1, 2)    = [2]
     * Arr.removeAll([2, 6, 3], 0, 2)    = [6]
     * Arr.removeAll([2, 6, 3], 0, 1, 2) = []
     * </pre>
     *
     * @param array   the array to remove the element from, may not be {@code null}
     * @param indices the positions of the elements to be removed
     ...
     *
     * <pre>
     * Arr.removeAll([true, false, true], 0, 2) = [false]
     * Arr.removeAll([true, false, true], 1, 2) = [true]
     * </pre>
     *
     * @param array   the array to remove the element from, may not be {@code null}
     * @param indices the positions of the elements to be removed
    ...
    static Object removeAll(final Object array, final BitSet indices) {
        final int srcLength = Arr.getLength(array);
