...
public final class TypeResolver {
	...
	public static boolean isOfStandardType(Object obj) {
		return obj instanceof String || obj instanceof Date || obj instanceof Timestamp ||
				obj instanceof Calendar || obj instanceof Boolean || obj instanceof Short ||
	...
	/**
	 * Call Class.forName("&hellip;") except that it does never throw ClassNotFoundException if the class was not found but return <b>null</b>
	 * @param sClassName String fully qualified class name
	 * @return Class or <b>null</b>
	 */
	public static Class getClassForName(String sClassName) {
		Class oRetVal;
		try {
